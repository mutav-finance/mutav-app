...
// extract (PR 6). The `src/lib/pricing/**` worktree exclude and the
// `apps/fund/src/lib/pricing/**` exclude (investor.test.ts runs under
// bun:test, not vitest) stay here because vitest's filter is repo-wide.
