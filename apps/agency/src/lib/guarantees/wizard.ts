...
import { PROPERTY_KIND, type PropertyKind } from "@convex/leases/domain";
...
export function isPropertyKind(value: string): value is PropertyKind {
  return value === PROPERTY_KIND.RESIDENTIAL || value === PROPERTY_KIND.COMMERCIAL;
}
...
export type CreditScoreRequestStatus = FunctionReturnType<
  typeof api.guarantees.useCases.requestCreditScore
>["status"];
